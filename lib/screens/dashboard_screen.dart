        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                '${user.displayName} · Dashboard operativo de auxilio y talleres',
        ...
        Row(
          children: [
            ...
            Container(
              ...
              child: IconButton(
                onPressed: onLogout,
                icon: const Icon(Icons.logout_rounded, color: Color(0xFF123F78)),
              ),
            ),
          ],
        ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            detail,
            style: const TextStyle(fontSize: 13, color: Color(0xFF66758C)),
          ),
        ],
      ),
    );
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(location, style: const TextStyle(color: Color(0xFF66758C))),
              ],
            ),
          ),
          Column(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          Text(specialty, style: const TextStyle(color: Color(0xFF55637C))),
          const SizedBox(height: 8),
          Text(
            coverage,
            style: const TextStyle(
